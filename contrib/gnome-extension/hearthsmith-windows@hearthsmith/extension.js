...
const IFACE = `
<node>
  <interface name="org.hearthsmith.Windows">
...
export default class ForgeWindows extends Extension {
    enable() {
        ...
        this._dbus.export(Gio.DBus.session, '/org/hearthsmith/Windows');
    }
    ...
    ScreenshotAsync([x, y, w, h], invocation) {
        const path = GLib.build_filenamev([GLib.get_tmp_dir(), `hearthsmith-shot-${Date.now()}.png`]);
